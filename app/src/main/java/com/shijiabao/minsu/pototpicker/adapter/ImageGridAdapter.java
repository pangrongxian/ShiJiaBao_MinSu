package com.shijiabao.minsu.pototpicker.adapter;
...
import com.shijiabao.minsu.pototpicker.utils.ImageDisplayer;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item.isSelected) {
            ...
            mHolder.selectedBgTv.setBackgroundResource(R.color.green_gray);
        }
