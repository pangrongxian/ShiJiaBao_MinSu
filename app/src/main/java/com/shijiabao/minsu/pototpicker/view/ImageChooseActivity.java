package com.shijiabao.minsu.pototpicker.view;
...
import com.shijiabao.minsu.pototpicker.adapter.ImageGridAdapter;
import com.shijiabao.minsu.pototpicker.model.ImageItem;
import com.shijiabao.minsu.pototpicker.utils.CustomConstants;
import com.shijiabao.minsu.pototpicker.utils.IntentConstants;
...
public class ImageChooseActivity extends Activity {
    ...
    private void initView() {
        ...
        mFinishBtn = (Button) findViewById(R.id.finish_btn);//点击完成按钮
    ...
    private void initListener() {
        mFinishBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {//跳转到 PublishActivity
